import { ref, unref, computed, onMounted, watch, reactive } from 'vue';
import { useTimeoutFn } from '/@/hooks/core/useTimeout';
import { buildUUID } from '/@/utils/uuid';
import { isFunction, isBoolean } from '/@/utils/is';
import { get, cloneDeep } from 'lodash-es';
import { FETCH_SETTING, ROW_KEY, PAGE_SIZE } from '../const';
export function useDataSource(propsRef, { getPaginationInfo, setPagination, setLoading, getFieldsValue, clearSelectedRowKeys, }, emit) {
    ...
    async function fetch(opt) {
        const { api, searchInfo, fetchSetting, beforeFetch, afterFetch, useSearchForm } = unref(propsRef);
