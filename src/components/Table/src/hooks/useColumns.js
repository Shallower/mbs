        ...
        if (!isString(firstColumn)) {
            ...
            if (!isEqual(cacheKeys, columns)) {
                newColumns.sort((prev, next) => {
                    return (columnKeys.indexOf(prev.dataIndex) -
                        columnKeys.indexOf(next.dataIndex));
                });
            }
...
function sortFixedColumn(columns) {
    ...
    const resultColumns = [...fixedLeftColumns, ...defColumns, ...fixedRightColumns].filter((item) => !item.defaultHidden);
