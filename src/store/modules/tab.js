...
__decorate([Mutation], Tab.prototype, 'commitClearCache', null);
__decorate([Mutation], Tab.prototype, 'goToPage', null);
__decorate([Mutation], Tab.prototype, 'commitCachedMapState', null);
__decorate([Mutation], Tab.prototype, 'commitTabRoutesState', null);
__decorate([Mutation], Tab.prototype, 'commitCloseTab', null);
__decorate([Mutation], Tab.prototype, 'commitCloseAllTab', null);
__decorate([Mutation], Tab.prototype, 'commitResetState', null);
__decorate([Mutation], Tab.prototype, 'commitSortTabs', null);
__decorate([Mutation], Tab.prototype, 'closeMultipleTab', null);
__decorate([Action], Tab.prototype, 'addTabAction', null);
__decorate([Mutation], Tab.prototype, 'commitRedoPage', null);
__decorate([Action], Tab.prototype, 'closeAllTabAction', null);
__decorate([Action], Tab.prototype, 'closeTabAction', null);
__decorate([Action], Tab.prototype, 'closeTabByKeyAction', null);
__decorate([Action], Tab.prototype, 'closeLeftTabAction', null);
__decorate([Action], Tab.prototype, 'closeRightTabAction', null);
__decorate([Action], Tab.prototype, 'closeOtherTabAction', null);
Tab = __decorate([Module({ namespaced: true, name: NAME, dynamic: true, store })], Tab);
